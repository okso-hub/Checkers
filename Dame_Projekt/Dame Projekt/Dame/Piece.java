...
{   
   ...
   protected Shape gibAktuelleFigur() {
       ...
       Rectangle2D viereck = new Rectangle2D.Double(0, 0, diameter, diameter);
       
       figur.append(kreis, false);
       if (isDame) {
           figur.append(viereck, false);
       }
       figur.append(Zahl.gibZahl(number), false);   
